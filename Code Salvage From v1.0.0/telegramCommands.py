# Just a file that holds all of the code for the telegram commands. The point is the the commands will be deleted but the code could be useful elsewhere so im saving it.

## Poweroff Command

### Repeating Part - At the top of the main code in the while loop. - Runs continuously then the status is true.
...
### Main bit of code for the command - Runs only when the command is requested.
